...
public class HomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         System.out.println("HOMESERVLET RESPONSING FOR WEBHIT!");
        ...
        if (containsKey == true) {
            ...
            if (methodName != null) {
                ...
                if (methodName.equals("index")) {
                    HomeMethod.indexPage(request, response);
                }

                if (methodName.equals("login")) {
                    HomeMethod.loginUser(request, response);
                }

                if (methodName.equals("menu")) {
                    HomeMethod.menuPage(request, response);
                }
            }
        }
    }
